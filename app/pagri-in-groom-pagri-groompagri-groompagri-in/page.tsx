...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/pagri-in-groom-pagri",
    type: "website",
  },
}
...
export default function PagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagri specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
