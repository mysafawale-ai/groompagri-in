...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/royal-wedding-turban-for-groom-in-groom-pagri",
    type: "website",
  },
}
...
export default function RoyalWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert turban specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
