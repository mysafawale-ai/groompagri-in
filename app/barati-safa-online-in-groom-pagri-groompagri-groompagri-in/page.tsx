...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/barati-safa-online-in-groom-pagri",
    type: "website",
  },
}
...
export default function BaratiSafaOnlineInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India"],
