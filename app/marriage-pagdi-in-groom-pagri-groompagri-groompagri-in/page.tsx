...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/marriage-pagdi-in-groom-pagri",
    type: "website",
  },
}
...
export default function MarriagePagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in India", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],
