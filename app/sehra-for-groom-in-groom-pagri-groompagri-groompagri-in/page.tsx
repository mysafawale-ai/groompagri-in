...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/sehra-for-groom-in-groom-pagri",
    type: "website",
  },
}
...
export default function SehraForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Expert sehra specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Complete barati packages with matching coordination"],
