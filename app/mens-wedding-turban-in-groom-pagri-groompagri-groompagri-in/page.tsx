...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/mens-wedding-turban-in-groom-pagri",
    type: "website",
  },
}
...
export default function MensWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India"],
