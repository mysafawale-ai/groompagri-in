...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/safa-for-groom-in-groom-pagri",
    type: "website",
  },
}
...
export default function SafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India"],
