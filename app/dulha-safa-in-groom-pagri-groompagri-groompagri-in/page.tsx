...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/dulha-safa-in-groom-pagri",
    type: "website",
  },
}
...
export default function DulhaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India"],
