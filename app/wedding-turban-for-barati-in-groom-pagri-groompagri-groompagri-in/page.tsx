...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/wedding-turban-for-barati-in-groom-pagri",
    type: "website",
  },
}
...
export default function WeddingTurbanForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India"],
