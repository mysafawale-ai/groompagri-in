...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/groom-sehra-in-groom-pagri",
    type: "website",
  },
}
...
export default function GroomSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
