...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/groom-pagdi-in-groom-pagri",
    type: "website",
  },
}
...
export default function GroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
