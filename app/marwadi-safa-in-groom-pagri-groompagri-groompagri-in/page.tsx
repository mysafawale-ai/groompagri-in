...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/marwadi-safa-in-groom-pagri",
    type: "website",
  },
}
...
export default function MarwadiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
