...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/feta-for-groom-in-groom-pagri",
    type: "website",
  },
}
...
export default function FetaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert feta specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
