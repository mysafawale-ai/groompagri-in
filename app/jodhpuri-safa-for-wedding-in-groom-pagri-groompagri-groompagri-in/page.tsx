...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/jodhpuri-safa-for-wedding-in-groom-pagri",
    type: "website",
  },
}
...
export default function JodhpuriSafaForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
