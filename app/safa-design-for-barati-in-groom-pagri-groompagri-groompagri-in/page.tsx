...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/safa-design-for-barati-in-groom-pagri",
    type: "website",
  },
}
...
export default function SafaDesignForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day"],
