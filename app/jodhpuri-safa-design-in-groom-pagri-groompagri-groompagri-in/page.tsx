...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/jodhpuri-safa-design-in-groom-pagri",
    type: "website",
  },
}
...
export default function JodhpuriSafaDesignInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
