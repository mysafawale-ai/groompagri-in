...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/pagdi-bandhne-wala-in-groom-pagri",
    type: "website",
  },
}
...
export default function PagdiBandhneWalaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
