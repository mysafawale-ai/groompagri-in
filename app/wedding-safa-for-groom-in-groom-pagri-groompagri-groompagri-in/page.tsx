...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/wedding-safa-for-groom-in-groom-pagri",
    type: "website",
  },
}
...
export default function WeddingSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics"],
