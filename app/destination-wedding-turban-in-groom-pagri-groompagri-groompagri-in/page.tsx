...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/destination-wedding-turban-in-groom-pagri",
    type: "website",
  },
}
...
export default function DestinationWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert turban specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
