...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/safa-for-men-in-groom-pagri",
    type: "website",
  },
}
...
export default function SafaForMenInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
