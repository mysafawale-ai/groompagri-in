...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/safa-for-barati-in-groom-pagri",
    type: "website",
  },
}
...
export default function SafaForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
