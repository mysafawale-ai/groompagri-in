...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/premium-pagdi-with-kalgi-in-groom-pagri",
    type: "website",
  },
}
...
export default function PremiumPagdiWithKalgiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day"],
