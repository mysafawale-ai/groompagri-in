...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/wedding-safa-draping-in-groom-pagri",
    type: "website",
  },
}
...
export default function WeddingSafaDrapingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
