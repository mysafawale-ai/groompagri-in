...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/heritage-feta-turban-hire-in-groom-pagri",
    type: "website",
  },
}
...
export default function HeritageFetaTurbanHireInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Expert feta specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders"],
