...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/customized-sehra-for-baraat-in-groom-pagri",
    type: "website",
  },
}
...
export default function CustomizedSehraForBaraatInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
