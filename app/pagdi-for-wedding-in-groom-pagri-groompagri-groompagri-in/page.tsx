...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.in/pagdi-for-wedding-in-groom-pagri",
    type: "website",
  },
}
...
export default function PagdiForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
